...
from scripts.common.publishers import facebook_video
from scripts.common.reel_uploader import process_reel_upload

def extract_metadata(meta_json):
    meta = meta_json.get("facebook", {})
    if not meta:
        raise ValueError("No facebook metadata found")
...
def upload_func(video_path, caption):
    facebook_video(video_path, caption)

if __name__ == "__main__":
    process_reel_upload("facebook", upload_func, extract_metadata)
