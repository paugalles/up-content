...
def extract_metadata(meta_json):
    platform_data = meta_json.get("instagram", {})
    caption = platform_data.get("carousel_post_description", "")
...
def upload_func(image_paths, caption):
    instagram(image_paths, caption)

if __name__ == "__main__":
    process_htmlcss_upload("instagram", "carousel", upload_func, extract_metadata)
