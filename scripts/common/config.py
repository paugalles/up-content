...
def branding() -> Branding:
    return Branding(
        name=os.getenv("BRAND_NAME") or "INMIBOT",
        site=os.getenv("BRAND_SITE") or "inmibot.es",
        cta_es=os.getenv("BRAND_CTA_ES") or "Consulta la guía completa en inmibot.es.",
        cta_en=os.getenv("BRAND_CTA_EN") or "Read the complete guide at inmibot.es.",
