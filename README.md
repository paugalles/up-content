...
language: en
url: "https://example.com/en/blog/residence-permit"
---
...
| `ARTICLE_BASE_URL` | No | All | Default sitemap base; default `https://example.com` |
| `ARTICLE_SITEMAP_URL_ES` | No | All | Spanish sitemap/index override |
| `ARTICLE_SITEMAP_URL_EN` | No | All | English sitemap/index override |
| `BRAND_NAME` | No | All assets/copy | Footer/prompt name; default `Social Publisher` |
| `BRAND_SITE` | No | All assets | Footer site; default `example.com` |
...
| `BRAND_LOGO_PATH` | No | All assets | Logo image path |
| `BRAND_PROFILE_PATH`| No | All assets | Profile image path |
