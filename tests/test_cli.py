...
class CliTests(unittest.TestCase):
    def test_all_platforms_support_generation_contract(self):
        for platform in ("youtube", "instagram", "facebook", "tiktok", "linkedin"):
    ...
    def test_generate_only_local_article_persists_assets_and_metadata(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            with patch.dict("os.environ", {"DRY_RUN": "true"}, clear=True), patch("scripts.common.pipeline.publishers.instagram") as publish:
